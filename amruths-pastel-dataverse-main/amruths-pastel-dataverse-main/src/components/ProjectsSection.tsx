...
const projects: Project[] = [
  ...
  },
  {
    ...
    technologies: ['Python', 'RAG', 'ChromaDB', 'Surya OCR', 'Sarvam AI', 'Streamlit'],
    ...
    highlights: [
      'Engineered a 7-stage OCR-to-RAG pipeline (pdf2image → OpenCV preprocessing → Surya OCR → semantic chunking → ChromaDB retrieval → LLM response).',
    ...
    architecture: ['PDF → Image', 'OpenCV Preprocess', 'Surya OCR', 'Semantic Chunking', 'ChromaDB Index', 'LLM + TTS'],
  },
  {
