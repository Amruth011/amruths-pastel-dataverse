  ...
  const experiences: Experience[] = [
    {
      ...
      mode: 'Forage',
      description: [
        'Completed a Forage job simulation focused on AI-powered financial chatbot development for BCG\'s GenAI consulting team.',
    ...
    },
    {
      ...
      mode: 'Forage',
      description: [
        'Completed a Forage job simulation on AI-powered data analytics and strategy for the Financial Services team',
    ...
    <section id="experience" className="py-24 relative">
      ...
      <div className="container mx-auto px-4 pt-16">
        <div className="max-w-5xl mx-auto">
          <SectionReveal>
            <p className="font-mono text-xs text-primary mb-4 tracking-widest uppercase">Simulations</p>
